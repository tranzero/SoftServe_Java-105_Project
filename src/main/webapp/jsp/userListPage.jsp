		...
		<tr>
			<th><spring:message code="label.users.userName" />
				...
				<div style="float: right">
					<a id="usernameasc" href="javascript:void(0);"> <img alt="^"
						src="resources/images/downarrow.png">
					</a> <a id="usernamedesc" href="javascript:void(0);"> <img alt="^"
						src="resources/images/uparrow.png">
					</a>
				</div></th>
			<th><spring:message code="label.users.firstName" />

				<div style="float: right">
					<a id="firstnameasc" href="javascript:void(0);"> <img alt="^"
						src="resources/images/downarrow.png">
					</a> <a id="firstnamedesc" href="javascript:void(0);"> <img alt="v"
						src="resources/images/uparrow.png">
					</a>
				</div></th>
			<th><spring:message code="label.users.lastName" />
				<div style="float: right">
					<a id="lastnameasc" href="javascript:void(0);"> <img alt="v"
						src="resources/images/downarrow.png">
					</a> <a id="lastnamedesc" href="javascript:void(0);"> <img alt="v"
						src="resources/images/uparrow.png">
					</a>
				</div></th>
			<th><spring:message code="label.users.email" />
				<div style="float: right">
					<a id="emailasc" href="javascript:void(0);"> <img alt="^"
						src="resources/images/downarrow.png">
					</a> <a id="emaildesc" href="javascript:void(0);"> <img alt="v"
						src="resources/images/uparrow.png">
					</a>
				</div></th>
			<th><spring:message code="label.users.role" />
				<div style="float: right">
					<a id="roleasc" href="javascript:void(0);"> <img alt="^"
						src="resources/images/downarrow.png">
					</a> <a id="roledesc" href="javascript:void(0);"> <img alt="v"
						src="resources/images/uparrow.png">
					</a>
				</div></th>
			<th><spring:message code="label.users.dateOfReg" />
				<div style="float: right">
					<a id="regdateasc" href="javascript:void(0);"> <img alt="^"
						src="resources/images/downarrow.png">
					</a> <a id="regdatedesc" href="javascript:void(0);"> <img alt="v"
						src="resources/images/uparrow.png">
					</a>
				</div></th>
			<th></th>
