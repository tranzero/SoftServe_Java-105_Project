		...
		<table class="form">
			<tbody>
				<tr>
					...
					<td align="center"><form:input id="stationCode"
							path="stationCode" name="stationCode" onfocus="checkpostal()" /></td>
				...
				<tr>
					...
					<td align="center"><form:input id="stationName"
							path="stationName" name="stationName" onfocus="checkpostal()" /></td>
