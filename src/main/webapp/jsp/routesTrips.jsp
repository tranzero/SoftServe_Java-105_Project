		...
		<div id="routesTrips">
			<div>
				<span class="pad_right">
					<spring:message code="label.stations.stationname" />
					<input type="text" id="stationList" name="nameStation"></input>
				</span>
				<span class="pad_right">
					<spring:message code="label.navigation.minTime" />
					<input type="text" id="timeMin" name="timeMin" size="10"></input>
				</span>
				<span class="pad_right">
					<spring:message code="label.navigation.maxTime" />
					<input type="text" id="timeMax" name="timeMax" size="10"></input>
				</span>
