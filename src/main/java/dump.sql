...
INSERT INTO `transports` VALUES (1,1,"T000000001","12:00:00",10,50,150,25.0),(2,1,"T000000001","16:00:00",10,50,150,25.0),(3,2,"T000000002","12:00:00",10,50,150,25.0),(4,2,"T000000002","16:00:00",10,50,150,25.0);
...
CREATE TABLE `trips` (
  ...
  `REMSEATCLASS1` INT NOT NULL,
  `REMSEATCLASS2` INT NOT NULL,
  `REMSEATCLASS3` INT NOT NULL,
  `STARTDATE` DATE NOT NULL,
  PRIMARY KEY (`TRIPID`),
  INDEX `transports_transportid_fk_idx` (`TRANSPORTID` ASC),
  CONSTRAINT `transports_transportid_fk`
    FOREIGN KEY (`TRANSPORTID`)
    REFERENCES `test`.`transports` (`TRANSPORTID`)
    ON DELETE CASCADE
